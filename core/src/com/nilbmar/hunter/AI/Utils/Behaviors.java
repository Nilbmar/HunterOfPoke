...
public abstract class Behaviors {
    ...
    public static SteeringBehavior<Vector2> getBehavior(SteeringAI steerable, NewEntity target, Behavior behavior) {
    ...
    public static SteeringBehavior<Vector2> arriveBehavior(SteeringAI steerable, NewEntity target) {
